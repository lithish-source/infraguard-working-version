...
def get_nearby_schools(lat: float, lng: float, radius_m: int = 5000) -> List[Dict]:
    ...
    (
      ...
      node["name"~"School|Matric|Vidyalaya|Academy|Kindergarten|Vidya|College|Nursery|Pranavan",i](around:{radius_m},{lat_r},{lng_r});
      way["name"~"School|Matric|Vidyalaya|Academy|Kindergarten|Vidya|College|Nursery|Pranavan",i](around:{radius_m},{lat_r},{lng_r});
    );
    out center 25;
    """
    try:
